...
namespace ECPay.Payment.Integration
{
    ...
    public class RequiredByPrintAttribute : RequiredAttribute
    {
        ...
        /// </summary>
        public RequiredByPrintAttribute() : base()
        {
        }
        ...
        public override bool IsValid(object value)
        {
            ...
            object oNeedCheckedValue = pdcProperties.Find("Print", true).GetValue(oSourceComponent);

            if (oNeedCheckedValue.Equals(PrintFlag.Yes))
