...
namespace ECPay.Payment.Integration
{
    ...
    public class ValidatePlatformArgumentsAttribute : ValidationAttribute
    {
        ...
        /// </summary>
        public ValidatePlatformArgumentsAttribute() : base()
        {
        }
        /// <summary>
        /// 是否檢核通過。
        ...
        public override bool IsValid(object value)
        {
            ...
            object oPlatformValue = pdcProperties.Find("PlatformID", true).GetValue(oSourceComponent);
            ...
            if (!String.IsNullOrEmpty(szPropertyValue) && String.IsNullOrEmpty(szPlatformValue))
            {
                return false;
            }
